      ...
      <div class="container py-5">
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto mb-4 mb-lg-0 order-1 order-lg-2">
            <div class="p-2 border"><img class="img-fluid" src="<?php echo base_url('assets/');?>img/about-img.jpg" alt=""></div>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="px-4 py-5 border border-width-md border-dash h-100">
             ...
             <h3 class="h5"><a href="#">Interview</a></h3>
              <p class="text-small mb-0 text-muted">In this section, view Raksha Mantri Shri Rajnath Singh's latest media interview.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="px-4 py-5 border border-width-md border-dash h-100">
