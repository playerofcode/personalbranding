...
<html>
  <head>
    ...
    <title id="print_name1"><?php echo $name; ?></title>
  ...
  <body>
    ...
    <header class="header">
      ...
      <nav class="navbar navbar-expand-lg navbar-light py-3 bg-white shadow-sm">
        <div class="container-fluid"><a class="navbar-brand" href="<?php echo base_url();?>" id="print_name2"><?php echo $name; ?></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item ml-2 dropdown"><a class="nav-link text-uppercase dropdown-toggle pr-0" id="navbarDropdownMenuLink" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $name;?></a>
                <div class="dropdown-menu mt-lg-4" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item font-weight-bold text-small" href="<?php echo base_url('home/biography'); ?>">Biography</a>
                  <a class="dropdown-item font-weight-bold text-small" href="<?php echo base_url('home/journey');?>">Journey</a>
                  <a class="dropdown-item font-weight-bold text-small" href="<?php echo base_url('home/achievements');?>">Achievements</a>
              </li>
